...
if choose == "数据上传":
    ...
    if selecte1 == "用户分布地区-条形图":
        ...
        st.image("用户分布地区.png",use_column_width=True)
        ...
        st.image("用户活跃度.png",use_column_width=True)
    ...
    if selecte2 == "推荐效果评估":
        ...
        st.image("推荐效果评估.png",use_column_width=True)

    elif selecte2 == "问答系统性能评估曲线":
        st.info('智能问答系统性能检测：确保高效、准确的问答体验。让学习更便捷！')
        st.image("问答系统性能评估.png",use_column_width=True)
...
if choose == "安全审计":
    ...
    if selecte4 == "审计日志表":
        ...
        st.image("安全审计1.png",use_column_width=True)
